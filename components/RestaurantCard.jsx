...
import { StatusBadge, Icon } from './atoms';

export default function RestaurantCard({ r, lang, span = 'sm', onClick, onHoverId, hoveredId }) {
  const c = COPY[lang];
  ...
  const handleClick = onClick || (() => { router.push('/r/' + r.id); });
