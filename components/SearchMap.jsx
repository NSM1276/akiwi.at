'use client';
// SearchMap — compact sticky map for split view. Uses Vienna district geometry.
...
export default function SearchMap({ lang, restaurants, hoveredId, setHoveredId }) {
