  ...
  'burgallio-1100': {
    ...
    menu: [
      { cat_de: 'Burger', cat_en: 'Burgers', items: [
        { name_de: 'Classic Burger', name_en: 'Classic burger' },
        { name_de: 'Cheeseburger', name_en: 'Cheeseburger' },
        { name_de: 'BBQ Burger', name_en: 'BBQ burger' },
        { name_de: 'Chili Burger', name_en: 'Chili burger' },
        { name_de: 'Chicken Burger', name_en: 'Chicken burger' },
      ...
      { cat_de: 'Beilagen & Snacks', cat_en: 'Sides & Snacks', items: [
        ...
        { name_de: 'Mozzarella Sticks', name_en: 'Mozzarella sticks', tag: 'V' },
      ]},
    ],
    reviews_list: [],
    verification_log: [
