// Menu, Reviews, Verification, Similar, Mini-map, Amenities

const Menu = ({ venue, lang }) => {
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
          ...
          <span style={{ display: 'flex', gap: 2, color: 'var(--accent)' }}>
            {[1,2,3,4,5].map((i) => (
              <window.Icon.star key={i} size={12} />
            ))}
          </span>
          ...
          <li key={i} style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
              ...
              <div style={{ display: 'flex', gap: 1, color: 'var(--accent)' }}>
                {[1,2,3,4,5].map((s) => (
                  <window.Icon.star key={s} size={11} />
                )).slice(0, r.rating)}
              </div>
            </div>
          ...
          <div style={{ padding: 12 }}>
            ...
            <div style={{ fontSize: 12, color: 'var(--text-secondary)', marginTop: 3, display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: 3, color: 'var(--accent)' }}>
                <window.Icon.star size={10} /> {s.rating}
              </span>
  ...
  return (
    <div style={{
      ...
      <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice"
        ...
        <text x="50" y="55" fontSize="3" textAnchor="middle" fill="var(--text-tertiary)" fontWeight="600">FAVORITEN</text>
      </svg>
      <div style={{
...
Object.assign(window, { Menu, Reviews, Verification, SimilarList, MiniMap, Amenities });
